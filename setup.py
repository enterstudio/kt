...
setup(
    ...
    description='A software for differential analysis on large cohort, from Kallisto quantification.',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/iric-soft/kt',
    ...
    keywords='k-mer RNA-seq differential sequencing large cohort',
